...
public class MainScreenInputManager extends InputAdapter {
    ...
    public boolean keyDown(int keycode) {
        ...
        switch(keycode){
            ...
            case Input.Keys.A: board.execute(player, new RotationCard(1, RotationType.COUNTER_CLOCKWISE)); break;
            case Input.Keys.D: board.execute(player, new RotationCard(1, RotationType.CLOCKWISE)); break;
            ...
            case Input.Keys.W: board.execute(player, new MovementCard(1, MovementType.THREE_FORWARD)); break;
            case Input.Keys.S: board.execute(player, new MovementCard(1, MovementType.ONE_BACKWARD)); break;
        }
